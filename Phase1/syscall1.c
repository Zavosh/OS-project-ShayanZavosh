...
int main(){
	...
	char time_string[40];
	gettimeofday(&tv, NULL);// this function put the current time in seconds in value of first argumet's pointer and time zone in value of second argumet's pointer
